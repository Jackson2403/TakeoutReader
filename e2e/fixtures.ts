...
export function makeTakeoutZip(): Buffer {
  const files: Record<string, string> = {
    'Takeout/YouTube/history/watch-history.json': JSON.stringify([
      { header: 'YouTube', title: 'Watched: A lovely cat video', time: '2023/05/01 12:00:00 UTC', subtitles: [{ name: 'Category Creators' }] },
      { header: 'YouTube', title: 'Watched: Intro to pasta making', time: '2023/05/02 09:00:00 UTC', subtitles: [{ name: 'Category Creators' }] },
    ]),
